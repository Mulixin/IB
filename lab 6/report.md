...
![создание html-файла и доступ по http](image/03.png){ #fig:004 width=70% height=70%}
...
![лог ошибок](image/04.png){ #fig:006 width=70% height=70%}
...
![доступ по http на 81 порт](image/05.png){ #fig:008 width=70% height=70%}
