...
![Права доступа](Image/1.jpg){ #fig:001 width=70% height=70%}
...
![Атрибут а](Image/2.jpg){ #fig:001 width=70% height=70%}
...
![Новый атрибут а](Image/3.jpg){ #fig:001 width=70% height=70%}
...
![Проверка атрибута](Image/4.jpg){ #fig:001 width=70% height=70%}
...
![Снятие атрибука а и добавление i](Image/5.jpg){ #fig:001 width=70% height=70%}

![Проверка атрибута](Image/6.jpg){ #fig:001 width=70% height=70%}
